				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="member/signup.jsp">Join</a> <a
					...
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu dropdown-menu-right"
							...
							<a class="dropdown-item" href="broad/broad_1st.jsp">1st
								Designated Hospital</a> <a class="dropdown-item"
								href="broad/broad_2nd.jsp">2nd Designated Hospital</a> <a
								class="dropdown-item" href="broad/broad_3rd.jsp">3rd
								Designated Hospital</a> <a class="dropdown-item"
								href="broad/broad_4th.jsp">4th Designated Hospital</a>
						</div></li>
